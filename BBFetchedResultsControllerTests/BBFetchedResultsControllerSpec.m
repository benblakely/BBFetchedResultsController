...
void(^importData)(NSArray *, NSManagedObjectContext *) = ^(NSArray *data, NSManagedObjectContext *managedObjectContext) {
...
describe(@"BBFetchedResultsController", ^{
    ...
    context(@"With nested contexts", ^{
        beforeEach(^{
            ...
            [managedObjectContext setParentContext:privateContext];
            importData(data, managedObjectContext);
            [managedObjectContext save:nil];
